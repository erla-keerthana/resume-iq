...
<div class="page" class:mounted>
	...
	<main class="login-container">
		<div class="login-card anim-fade-up" style="--delay: 0s">
			<!-- Brand header -->
			<div class="login-header anim-fade-up" style="--delay: 0.1s">
				...
				<p>Sign in to continue to ResumeIQ</p>
			</div>
			...
			<form class="login-form" onsubmit={handleLogin}>
				...
				<button type="submit" class="submit-btn anim-fade-up" style="--delay: 0.25s" disabled={loading}>
					{#if loading}
			...
			<p class="login-footer anim-fade-up" style="--delay: 0.3s">
				Don't have an account? <a href="{base}/signup" class="link">Create one</a>
			</p>
		</div>
	</main>
</div>
